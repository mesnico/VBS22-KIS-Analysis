...
class Tasks:
    ...
    def add_task(self, name, started, ended, duration, position, uid, taskType, correct_video, target_start_ms, target_end_ms):
        ...
        self.tasks_df = self.tasks_df.append({
            ...
            'target_end_ms': target_end_ms}, ignore_index=True
        )
